...
use App\Http\Controllers\Owner\OwnerGuestStayReviewController;
...
Route::get('/index2', [MarketplaceController::class, 'index2'])->name('home.index2');
...
Route::middleware('auth')->prefix('guest')->name('guest.')->group(function () {
    Route::get('/', GuestDashboardController::class)->name('dashboard');
    Route::get('/favourites', [GuestFavouriteController::class, 'index'])->name('favourites.index');
    Route::post('/favourites/{property}', [GuestFavouriteController::class, 'store'])->name('favourites.store');
    Route::delete('/favourites/{property}', [GuestFavouriteController::class, 'destroy'])->name('favourites.destroy');
    Route::get('/messages', [GuestMessageController::class, 'index'])->name('messages.index');
...
Route::prefix('owner')->name('owner.')->group(function () {
    ...
    Route::middleware(['auth', 'business.context'])->group(function () {
        ...
        Route::get('/messages', [OwnerMessageController::class, 'index'])->middleware('permission:booking.communicate')->name('messages.index');
        ...
        Route::get('/bookings/{booking}/messages', [OwnerMessageController::class, 'show'])->middleware('permission:booking.communicate')->name('bookings.messages.show');
        Route::post('/bookings/{booking}/messages', [OwnerMessageController::class, 'store'])->middleware(['permission:booking.communicate', 'business.mutation'])->name('bookings.messages.store');
        Route::post('/bookings/{booking}/guest-review', OwnerGuestStayReviewController::class)->middleware(['permission:booking.communicate', 'business.mutation'])->name('bookings.guest-review.store');
        ...
        Route::post('/team/roles', [OwnerTeamController::class, 'storeRole'])->middleware(['permission:employee.manage_capabilities', 'business.mutation'])->name('team.roles.store');
        Route::get('/team/{membership}', [OwnerTeamController::class, 'show'])->middleware('permission:employee.invite')->name('team.show');
        ...
        Route::patch('/team/{membership}/reactivate', [OwnerTeamController::class, 'reactivate'])->middleware(['permission:employee.remove', 'business.mutation'])->name('team.reactivate');
        Route::patch('/team/roles/{role}/permissions', [OwnerTeamController::class, 'updateRolePermissions'])->middleware(['permission:employee.manage_capabilities', 'business.mutation'])->name('team.roles.permissions.update');
