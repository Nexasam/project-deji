...
After login, the administrator is sent to `/admin/properties`, where submitted properties can be reviewed, published, rejected with a reason, or unpublished. Publishing and rejection update the property and marketplace-listing records together; do not change a single database status directly.
