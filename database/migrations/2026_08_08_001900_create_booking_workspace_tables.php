...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('booking_staff_assignments')) {
        ...
        if (! Schema::hasTable('property_access_instructions')) {
        ...
        if (! Schema::hasTable('booking_financial_documents')) {
            ...
            $foreignKeys = collect(Schema::getForeignKeys('booking_financial_documents'));

            Schema::table('booking_financial_documents', function (Blueprint $table) use ($foreignKeys) {
                if (! Schema::hasIndex('booking_financial_documents', ['business_id', 'document_number'], 'unique')) {
                    $table->unique(['business_id', 'document_number']);
                }

                if (! Schema::hasIndex('booking_financial_documents', ['business_id', 'id'], 'unique')) {
                    $table->unique(['business_id', 'id']);
                }

                if (! Schema::hasIndex('booking_financial_documents', 'booking_financial_document_lookup')) {
                    $table->index(['business_id', 'booking_id', 'document_type', 'document_status'], 'booking_financial_document_lookup');
                }
        ...
        if (! Schema::hasTable('booking_financial_document_items')) {
        ...
        if (! Schema::hasTable('booking_payment_installments')) {
        ...
        if (! Schema::hasTable('business_automation_settings')) {
