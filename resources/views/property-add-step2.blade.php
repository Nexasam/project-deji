        ...
        <header class="bg-white border-b border-gray-200">
            <div class="max-w-3xl mx-auto px-6 py-3 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-xs text-gray-500">Step 2 of 9</span>
            ...
            <div class="w-full max-w-3xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 mb-4">
                    ...
                    <div class="relative mb-3">
                        ...
                        <input type="text" placeholder="Start typing a street, estate or landmark..."
                    ...
                    <div class="relative w-full h-48 bg-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div class="absolute inset-0 flex items-end justify-center pb-4 pointer-events-none">
                            <div class="bg-black/60 text-white px-4 py-2 rounded-lg text-center">
                                <p class="text-xs font-medium">Search an address above to drop a pin here</p>
                            </div>
                        </div>
                        <div class="absolute bottom-2 right-2 text-[10px] text-gray-500">Google Maps</div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 mb-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        <select class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-[#FF5A00] appearance-none bg-white text-gray-500">
                ...
                <div class="flex items-center justify-between">
                    <a href="/owner/properties/create/step1" class="text-sm text-gray-500 hover:text-gray-700 transition-colors underline">Back</a>
                    <a href="/owner/properties/create/step3" class="bg-[#FF5A00] hover:bg-[#E55000] text-white font-bold py-2.5 px-8 rounded-lg text-sm transition-colors shadow-md inline-block">Next Step</a>
                </div>
            </div>
        </main>
    </div>
