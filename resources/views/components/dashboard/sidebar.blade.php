<aside class="w-[240px] bg-[#1D1D1F] text-gray-400 flex-shrink-0 flex-col border-r-2 border-[#FF5A00] max-md:hidden flex">
    <div class="flex-1 flex flex-col">
        {{-- Brand --}}
        <div class="px-5 py-3.5 border-b border-gray-800 flex-shrink-0">
            <div class="flex items-center gap-2">
                <img src="/logo1.png" alt="VS Logo" class="h-8 w-auto" />
                <span class="text-white text-sm font-semibold tracking-wide">Verified Shortlet</span>
            </div>
        </div>

        {{-- Workspace Selector --}}
        <div class="px-4 py-3.5 flex-shrink-0">
            <div class="bg-[#2b2b2b] rounded-lg px-3 py-2.5 flex items-center gap-3 cursor-pointer hover:bg-[#333333] transition-colors">
        ...
        {{-- Navigation --}}
        <nav class="px-4 py-2 space-y-4 flex-1">
            {{-- Overview Section --}}
            <div>
                <div class="text-[10px] font-bold text-gray-600 uppercase tracking-wider px-2.5 mb-2">Overview</div>
                <div class="space-y-0.5">
                    <a href="/dashboard" class="flex items-center gap-3 px-3 py-2 rounded-md bg-[#2b2b2b] text-[#FF5A00] text-sm font-medium transition-colors">
                    ...
                    <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-[#2b2b2b] text-gray-400 text-sm transition-colors">
            ...
            {{-- Manage Section --}}
            <div>
                <div class="text-[10px] font-bold text-gray-600 uppercase tracking-wider px-2.5 mb-2">Manage</div>
                <div class="space-y-0.5">
                    <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-[#2b2b2b] text-gray-400 text-sm transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- System Section --}}
            <div>
                <div class="text-[10px] font-bold text-gray-600 uppercase tracking-wider px-2.5 mb-2">System</div>
                <div class="space-y-0.5">
                    <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-[#2b2b2b] text-gray-400 text-sm transition-colors">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
