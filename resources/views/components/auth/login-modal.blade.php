...
>
    <div 
        ...
        style="max-width:480px; border-radius:24px;"
    >
        {{-- Close --}}
        <button 
            @click="$store.modals.closeAll()"
            class="absolute top-4 right-4 z-10 flex items-center justify-center rounded-lg"
            style="width:34px;height:34px;background:#FF5A00;border:none;cursor:pointer;"
        ...
        <div style="padding:40px 44px;">
            ...
            <div style="margin-bottom:28px;">
                <h2 style="font-family:'Inter',sans-serif;font-size:24px;font-weight:700;color:#111827;margin:0 0 6px;">Welcome back</h2>
                <p style="font-family:'Inter',sans-serif;font-size:13px;color:#6B7280;margin:0;">Sign in to your account to continue</p>
            </div>

            {{-- Social --}}
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;margin-bottom:22px;">
                <button type="button" onclick="window.location.href='/dashboard'"
                    style="display:flex;align-items:center;justify-content:center;gap:7px;padding:10px;background:#F9FAFB;border:1px solid #E5E7EB;border-radius:10px;cursor:pointer;"
            ...
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:22px;">
                ...
                <span style="font-size:11px;color:#9CA3AF;font-family:'Inter',sans-serif;font-weight:500;text-transform:uppercase;letter-spacing:.06em;white-space:nowrap;">or sign in with email</span>
                <div style="flex:1;height:1px;background:#E5E7EB;"></div>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" style="display:flex;flex-direction:column;gap:16px;">
                ...
                <div>
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
                        <label style="font-size:12px;font-weight:600;color:#374151;font-family:'Inter',sans-serif;">Password</label>
                        <a href="#" style="font-size:12px;color:#FF5A00;font-weight:500;font-family:'Inter',sans-serif;text-decoration:none;"
            ...
            <p style="text-align:center;font-size:13px;color:#6B7280;margin-top:20px;font-family:'Inter',sans-serif;">
                ...
                <button type="button" @click="$store.modals.openSignup()"
                    style="background:none;border:none;cursor:pointer;color:#FF5A00;font-weight:600;font-size:13px;font-family:'Inter',sans-serif;padding:0;margin-left:4px;">
                    Create one free
                </button>
            </p>
        </div>
