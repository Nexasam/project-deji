...
<body class="bg-gray-100 font-sans antialiased" x-data="{ amenities: ['wifi', 'power-backup', 'smart-tv', 'swimming-pool', '24-7-security', 'free-parking'] }">
    <div class="min-h-screen flex flex-col">
        ...
        <header class="bg-white border-b border-gray-200">
            ...
            <div class="h-0.5 bg-gray-200"><div class="h-0.5 bg-[#FF5A00]" style="width: 44.44%"></div></div>
        </header>
        ...
        <main class="flex-1 px-4 py-7">
            <div class="w-full max-w-5xl mx-auto">
                <div class="mb-5">
                    ...
                    <p class="text-gray-500 text-sm">Select everything that applies — these become filters guests use to search.</p>
                </div>

                {{-- Amenities Selection --}}
                <div class="bg-white rounded-xl shadow-sm p-5 mb-5">
                    <div class="mb-5">
                        <h2 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Essentials</h2>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('ac') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('kitchen') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('washing-machine') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('water-heater') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('power-backup') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                    ...
                    <div class="mb-5">
                        <h2 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Entertainment</h2>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('smart-tv') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('gaming') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('sound-system') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('netflix') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                    ...
                    <div class="mb-5">
                        <h2 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Leisure</h2>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('swimming-pool') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('gym') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('bbq') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('balcony') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                    ...
                    <div>
                        <h2 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Safety & Parking</h2>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('24-7-security') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('cctv') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('smoke-detector') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
                            ...
                            <label class="flex items-center gap-2.5 p-3 border-2 rounded-lg cursor-pointer transition-all text-sm" :class="amenities.includes('free-parking') ? 'border-[#FF5A00] bg-orange-50' : 'border-gray-200 hover:border-gray-300'">
